...
const Signup = () => {
  ...
  const [memberInviteToken, setMemberInviteToken] = useState("");
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={({ target }) => setSuperAdminCode(target.value)}
            ...
            />
             ...
             <Input
              value={memberInviteToken}
              onChange={({ target }) => setMemberInviteToken(target.value)}
              label="Member Invite Token"
              placeholder="Enter Member Invite Token"
              type="text"
            />
          </div>
